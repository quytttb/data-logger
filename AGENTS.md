...
Ứng dụng giám sát cảm biến công nghiệp chạy trên **Raspberry Pi (ARM64, kiosk)**: đọc cảm biến qua **Modbus RTU (RS-485)**, lưu **SQLite (WAL)**, GUI cảm ứng **Qt 6.11 + QML**, xuất báo cáo **TXT** theo **Thông tư 10/2021 — Phụ lục 15 (TT10)** và đồng bộ **FTP**. Edge cũng là **Modbus TCP Server** + **REST API** để Central Logger kết nối.
