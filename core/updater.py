    ...
    def run(self):
        try:
            ...
            if latest_version <= current_version:
                self.finished.emit(True, f"You are already on the latest version (v{current_version}).")
                return
            ...
            if rc.returncode == 0:
                ...
                self.finished.emit(True, "OTA update completed successfully. Please restart the application.")
            else:
