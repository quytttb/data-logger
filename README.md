...
export QT_DIR=$HOME/Qt/6.13.0/gcc_64
...
cmake -B build-release \
  ...
  -DCMAKE_PREFIX_PATH=$HOME/Qt/6.13.0/gcc_64   # bỏ nếu dùng apt
...
export LD_LIBRARY_PATH=$HOME/Qt/6.13.0/gcc_64/lib:$LD_LIBRARY_PATH
