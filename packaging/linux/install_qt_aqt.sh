#!/usr/bin/env bash
# Install Qt 6.12.0 + addons via aqtinstall (same modules as CI workflows).
set -euo pipefail

version="${QT_VERSION:-6.12.0}"
...
for pkg in Qt6Graphs Qt6SerialBus Qt6TaskTree Qt6Quick3D Qt6ShaderTools Qt6HttpServer; do
