    ...
    ColumnLayout {
        ...
        StackLayout {
            ...
            RowLayout {
                ...
                TextField { id: dLinearA; Layout.fillWidth: true; text: "1"; inputMethodHints: Qt.ImhFormattedNumbersOnly; EnterKeyAction.actionId: EnterKeyAction.None; EnterKeyAction.label: qsTr("OK") }
                Text { text: "b:"; color: Theme.textLabel; font.pixelSize: Theme.fontLabelSize }
                TextField { id: dLinearB; Layout.fillWidth: true; text: "0"; inputMethodHints: Qt.ImhFormattedNumbersOnly; EnterKeyAction.actionId: EnterKeyAction.None; EnterKeyAction.label: qsTr("OK") }
            }
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    TextField { id: dRawMin; text: "4000"; Layout.fillWidth: true; inputMethodHints: Qt.ImhFormattedNumbersOnly; EnterKeyAction.actionId: EnterKeyAction.None; EnterKeyAction.label: qsTr("OK") }
                    Text { text: "Max:"; color: Theme.textLabel; font.pixelSize: Theme.fontLabelSize }
                    TextField { id: dRawMax; text: "20000"; Layout.fillWidth: true; inputMethodHints: Qt.ImhFormattedNumbersOnly; EnterKeyAction.actionId: EnterKeyAction.None; EnterKeyAction.label: qsTr("OK") }
                }
                RowLayout {
                    spacing: 8
                    Text { text: "ScaleMin:"; color: Theme.textLabel; font.pixelSize: Theme.fontLabelSize; Layout.preferredWidth: 60 }
                    TextField { id: dScaleMin; text: "4"; Layout.fillWidth: true; inputMethodHints: Qt.ImhFormattedNumbersOnly; EnterKeyAction.actionId: EnterKeyAction.None; EnterKeyAction.label: qsTr("OK") }
                    Text { text: "Max:"; color: Theme.textLabel; font.pixelSize: Theme.fontLabelSize }
                    TextField { id: dScaleMax; text: "20"; Layout.fillWidth: true; inputMethodHints: Qt.ImhFormattedNumbersOnly; EnterKeyAction.actionId: EnterKeyAction.None; EnterKeyAction.label: qsTr("OK") }
                }
            }
            TextField { id: dCoeffJson; text: "{}"; Layout.fillWidth: true; EnterKeyAction.actionId: EnterKeyAction.None; EnterKeyAction.label: qsTr("OK") }
        }
    }
}
